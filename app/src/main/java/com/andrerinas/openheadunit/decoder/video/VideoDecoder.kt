...
class VideoDecoder(
     ...
     * that [com.andrerinas.openheadunit.decoder.video.KeyframeCycleEscalationPolicy] uses to decide whether
     ...
     * [com.andrerinas.openheadunit.decoder.video.WarmRelaunchKeyframePolicy], which must not have a second
