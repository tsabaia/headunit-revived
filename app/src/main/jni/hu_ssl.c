...
int hu_ssl_prepare()
{
    ...
    hu_ssl_method = (SSL_METHOD *) TLS_client_method();
...
int hu_ssl_bio_read(int offset, int res_max, jbyte *res_buf)
{
    if (hu_ssl_wm_bio == NULL) return -1;
...
{
    if (hu_ssl_rm_bio == NULL) return -1;
